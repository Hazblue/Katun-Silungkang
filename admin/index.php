...
session_start();
    //koneksi ke database 
    $koneksi =  new mysqli("localhost","root","","ontensi");
...
<head>
    ...
    <title>Katun Silungkang | Admin</title>
	<!-- BOOTSTRAP STYLES-->
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="../img/c.png" class="user-image img-responsive"/>
					</li>
                    ...
                    <li><a href="index.php?halaman=ongkir"><i class="fa fa-truck fa-3x"></i>Ongkir</a></li>
                    <li><a href="index.php?halaman=packing"><i class="fa fa-gift fa-3x"></i>Packing</a></li>
                </ul>
