...
//            $dec = "";
            ...
            //decrypt
//            for($i = 0; $i < strlen($detail['alamat_pengiriman']); $i++) {
//                $m = ord($detail['alamat_pengiriman'][$i]);
//                if($m <= 123) {
//                    $dec = $dec.chr(decRSA($m));
//                }
//                else {
//                    $dec = $dec.$detail['alamat_pengiriman'][$i];
//                }
//            }

            $d_alamat = decrypt($detail['alamat_pengiriman']);
            echo $d_alamat; ?> </td>	<br>
	</tr>
	<tr>
