...
<?php
	...
	if (isset($_POST["daftar"])){
					...
					else
					{
						...
						$qrCode = $googleAuthenticator->getQRCodeGoogleUrl($nama, $mfaSecret);
						//var_dump($qrCode);

						$koneksi->query("INSERT INTO pelanggan(email_pelanggan,password_pelanggan,nama_pelanggan,telepon_pelanggan,alamat_pelanggan, mfa_secret,role) VALUES ('$email', '$password', '$nama', '$telepon', '$alamat','$mfaSecret','$role')");
					...
					<form method="post">
						...
						<div class="row">
							<div class="input-group">
								...
								<input type="text" name="alamat_pelanggan" class="form-control" placeholder="Alamat" required></input>
					 		</div>
						</div>
						<div class="row">
							<div class="input-group">
								...
								<input type="text" name="telepon_pelanggan" class="form-control" placeholder="No Telepon" required></input>
						    </div>
						</div>
 						<div class="row">
 							<?php
