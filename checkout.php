...
//                $enc = "";
					...
					if(isset($_POST["checkout"]))
					{
                        ...
                        $e_alamat = encrypt($alamat_pengiriman);
                        //encrypt
//                        for($i = 0; $i < strlen($alamat_pengiriman); $i++) {
//                            $m = ord($alamat_pengiriman[$i]);
//                            if($m <= 119) {
//                                $enc = $enc.chr(encRSA($m));
//                            }
//                            else {
//                                $enc = $enc.$alamat_pengiriman[$i];
//                            }
//                        }
//						$enc=encryptthis($alamat_pengiriman, $key);
						...
						$tarif_packing = $arraypacking['tarif_packing'];
						 ...
						 ('$id_pelanggan', '$id_ongkir', '$tanggal_pembelian', '$total_pembelian', '$nama_kota', '$tarif', '$jenis_packing', '$tarif_packing', '$e_alamat') ");
...
//							$nama = ;
							$e_napro = encrypt($perproduk ['nama_produk']);
							$harga = $perproduk['harga_produk'];
							$subharga = $perproduk['harga_produk']*$jumlah;
							$koneksi->query("INSERT INTO pembelian_produk (id_pembelian,id_produk,nama,harga,subharga,jumlah)
								VALUES ('$id_pembelian_barusan', '$id_produk', '$e_napro' , '$harga' , '$subharga' ,'$jumlah') ");
